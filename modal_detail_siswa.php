	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-horizontal" id="ambil_cetak">
					...
					<div class="form-group">
						<label class="control-label col-xs-4" for="ot_eml">Jurusan</label>
						<div class="col-xs-8"><p class="form-control-static" id="ot_eml"></p></div>
					</div>
					<hr>
					<legend style="text-align:left !important">Data orang tua / wali</legend>
					<div class="form-group">
...
<script type="text/javascript">
	...
	function cetak (id_siswa) {
		...
		// Tampilkan modal
		//$("#modal_detail").modal("show");
		//$("#printing-frame").attr("srcdoc",$("#ambil_cetak").html());
		printDiv("ambil_cetak");
	}
