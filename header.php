<!DOCTYPE html>
	...
	<head>
		<title>
			Data Hasil Survey Peminatan SMK Negeri 1 Gedangan Malang
		</title>
		<!-- Styling -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="ppdbjatim.php">Info Jadwal PPDB</a></li>
							<li><a class="nav-link" href="index.php">Isi Survey</a></li>
							<li><a class="nav-link" href="infodaftar.php">Responden/Peserta Survey</a></li>
	    	...
	    	<div class="row">
		    	<div class="col-md-12">
	    			<h3 class="text-center">
	    				<B>Silahkan Isikan Biodata Anda di Bawah ini agar tidak tertinggal informasi</B></br>
	    				<BLINK>Formulir Survey Peminatan Kompetensi Keahlian SMK Negeri 1 Gedangan</BLINK>
	    			</h3>
		    	</div>
	    	</div>
    	</div>
