				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<a href="#daftar_siswa" id="daftar_siswa_tab" role="tab" data-toggle="tab" aria-controls="daftar_siswa" aria-expanded="true"><i class="glyphicon glyphicon-user"></i> Daftar Responden</a></li>
						</ul>
				    <!-- Tab content -->
							...
							<div role="tabpanel" class="tab-pane fade active in" id="daftar_siswa" aria-labelledby="daftar_siswa_tab">
								<div class="row">
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
										<h4>
											Daftar Responden Survey Peminatan Kompetensi Keahlian SMK Nega
										</h4>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
									...
									<table class="table table-striped" id="datatable">
										<thead>
											<tr>
												...
												<th>Asal Sekolah</th>
												<!-- <th>Telepon</th> -->
												<th>Pilihan Kompetensi Keahlian</th>
												<!--<th>Status</th> -->
												<th>Aksi</th> 
											</tr>
										</thead>
									...
									//		mysql_connect("localhost", "nilaiktsp", "p4ssw0rd");
											// Ambil semua data calon siswa
												...
												//	$view    .= "<td id='nama_ot_$data_id'>".stripslashes($dt["nama_orang_tua_wali"])."</td>";
													...
													$view    .= "<td id='tgl_daftar_$data_id'>$tgl_daftar_break</td>";
