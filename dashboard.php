										...
										<tbody>
											...
											// Ambil semua data calon siswa
												...
												foreach ($data as $dt) {
													...
													$view    .= "<button class='btn btn-sm btn-primary' data-toggle='modal' data-target='#modal_detail' onclick=lihat_detaild('$data_id') title='Detail Calon Siswa'> <!--<i class='glyphicon glyphicon-eye-open'></i>--> Detail</button>";
