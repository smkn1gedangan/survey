		...
		if ($resultJson['success'] == true){
			...
			if ($data_id_cek!="") {
				...
				if ($proses_simpan>=1) {
					...
					$mail->Username = "bagaswinardi@gmail.com";

					//Password to use for SMTP authentication
					$mail->Password = "isty@2018";

					//Set who the message is to be sent from
					$mail->setFrom('smkn1-gedanganmalang@yahoo.co.id', 'PPDB SMK NEGERI 1 Gedangan');

					//Set an alternative reply-to address
					$mail->addReplyTo('bagaswinardi@gmail.com', 'PPDB SMK NEGERI 1 Gedangan');
